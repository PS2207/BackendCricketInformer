package com.cricket.info.entities;
...
public class Match {
  ...
  private String teamHeading; //India vs Pak
  private String matchNumberVenue; //10th Match Today * at Bengaluru, M.Chinnaswamy Stadium
  private String battingTeam; //Ind
  private String battingTeamScore; //100-1(9.2 Ovs)
  private String bowlTeam; //Pak India Opt to bat first
...
// creating method to set the match status according to textComplete
